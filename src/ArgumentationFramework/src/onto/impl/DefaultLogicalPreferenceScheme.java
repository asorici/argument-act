...
/**
* Protege name: http://www.owl-ontologies.com/Ontology1295096279.owl#LogicalPreferenceScheme
* @author OntologyBeanGenerator v4.1
* @version 2011/02/8, 19:01:12
*/
public class DefaultLogicalPreferenceScheme implements LogicalPreferenceScheme {

  private static final long serialVersionUID = -3637768939741971919L;

  private String _internalInstanceName = null;

  public DefaultLogicalPreferenceScheme() {
    this._internalInstanceName = "";
  }

  public DefaultLogicalPreferenceScheme(String instance_name) {
