...
/**
* Protege name: http://www.owl-ontologies.com/Ontology1295096279.owl#Presumption
* @author OntologyBeanGenerator v4.1
* @version 2011/02/8, 19:01:12
*/
public class DefaultPresumption implements Presumption {

  private static final long serialVersionUID = -3637768939741971919L;

  private String _internalInstanceName = null;

  public DefaultPresumption() {
    this._internalInstanceName = "";
  }

  public DefaultPresumption(String instance_name) {
