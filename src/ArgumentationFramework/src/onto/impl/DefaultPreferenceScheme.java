...
/**
* Protege name: http://www.owl-ontologies.com/Ontology1295096279.owl#PreferenceScheme
* @author OntologyBeanGenerator v4.1
* @version 2011/02/8, 19:01:12
*/
public class DefaultPreferenceScheme implements PreferenceScheme {

  private static final long serialVersionUID = -3637768939741971919L;

  private String _internalInstanceName = null;

  public DefaultPreferenceScheme() {
    this._internalInstanceName = "";
  }

  public DefaultPreferenceScheme(String instance_name) {
