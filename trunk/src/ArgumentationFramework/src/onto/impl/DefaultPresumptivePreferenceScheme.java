...
/**
* Protege name: http://www.owl-ontologies.com/Ontology1295096279.owl#PresumptivePreferenceScheme
* @author OntologyBeanGenerator v4.1
* @version 2011/02/8, 19:01:12
*/
public class DefaultPresumptivePreferenceScheme implements PresumptivePreferenceScheme {

  private static final long serialVersionUID = -3637768939741971919L;

  private String _internalInstanceName = null;

  public DefaultPresumptivePreferenceScheme() {
    this._internalInstanceName = "";
  }

  public DefaultPresumptivePreferenceScheme(String instance_name) {
